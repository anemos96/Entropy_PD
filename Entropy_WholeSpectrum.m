...
for f = 1:length(input_files)
    ...
    clean_file_name = file_name(1:end-14);
...
% Set folders
work_dir = '/mnt/raid/RU1/Raw_data/Ettore/Entropy/Healthy/Entropy_Analysis/Results_WholeSpectrum/';
cd(work_dir);

% Load result table
load EntropyResults_channel.mat;
load Results_Entropy.mat
