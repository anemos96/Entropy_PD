...
input_folder = '/mnt/raid/RU1/Raw_data/Ettore/Entropy/Healthy/EEG_Data_Raw/resting_2/'
output_folder = '/mnt/raid/RU1/Raw_data/Ettore/Entropy/Healthy/Preprocessing_Output_2/'
...
for i = 1:length(file_list)
    ...
    EEG = pop_loadbv([input_folder file_name], 'dataformat', 'auto', 'memmapfile', '')
